...
export const webDevTools = ["javascript", "typescript", "react", "ember", "html", "css", "styled-components"]
...
const mapSrc = { 
  ...
  "browserstack": "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/browserstack/browserstack-original-wordmark.svg",
...
const mapImages = {
  "styled-components": <img src={StyledComp} key="styled" alt="styled components" width="60"/>,
  "cypress": <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cypressio/cypressio-original-wordmark.svg" key="cypress" alt="cypress" height={90} />,
  "testing-library": <img src={TestingLib} key="testing" alt="testing library" width="60" height="60" />,
  "qtest": <img src={Qtest} key="qtest" alt="qtest" width="50" />,
  "react": <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original-wordmark.svg" key="react" alt="react" height={60} style={{backgroundColor: "rgba(0, 0, 0, 0.7)"}} />,
