...
export const webDevTools = ["js", "ts", "react", "ember", "html", "css", "styled-components"]
...
export const getImage = (tool) => {
  const mapImages = { 
    ...
    "qtest": <img src={Qtest} alt="qtest" width="50" />,
    ...
    "react": <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original-wordmark.svg" alt="react" height={60} style={{backgroundColor: "rgba(0, 0, 0, 0.7)"}} />,
    "webpack": <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/webpack/webpack-original.svg" alt="webpack" height={60} style={{backgroundColor: "rgba(0, 0, 0, 0.7)"}} />,
    ...
    "styled-components": <img src={StyledComp} alt="styled components" width="60" />
    }
    return mapImages[tool]
    // return {
    //   <img src={mapImages[tool]} alt={tool} height={60} />
    // }
  }